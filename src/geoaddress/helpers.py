"""Address-related helpers for geoaddress."""
...
from .backends import BaseAddressBackend

# Default minimum confidence for address search
try:
...
def search_addresses(
    ...
    **kwargs: Any,
    ...
    Example:
        >>> config = [{"class": "geoaddress.backends.nominatim.NominatimAddressBackend", "config": {}}]
